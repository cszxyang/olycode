package github.cszxyang.olycode.java.proxy;
...
public final class ProxyScanner implements Iterator<String>, Closeable {
     ...
     */
    private ProxyScanner(Readable source, Pattern pattern) {
     ...
     *         interface
     */
    public ProxyScanner(Readable source) {
     ...
     */
    public ProxyScanner(InputStream source) {
     ...
     *         does not exist
     */
    public ProxyScanner(InputStream source, String charsetName) {
     ...
     */
    public ProxyScanner(File source) throws FileNotFoundException {
     ...
     *         not found
     */
    public ProxyScanner(File source, String charsetName)
            throws FileNotFoundException
    {
        this(Objects.requireNonNull(source), toDecoder(charsetName));
    }

    private ProxyScanner(File source, CharsetDecoder dec)
            throws FileNotFoundException
    {
     ...
     * @since   1.7
     */
    public ProxyScanner(Path source)
            throws IOException
    {
     ...
     * @since   1.7
     */
    public ProxyScanner(Path source, String charsetName) throws IOException {
        this(Objects.requireNonNull(source), toCharset(charsetName));
    }

    private ProxyScanner(Path source, Charset charset)  throws IOException {
     ...
     */
    public ProxyScanner(String source) {
     ...
     */
    public ProxyScanner(ReadableByteChannel source) {
     ...
     *         does not exist
     */
    public ProxyScanner(ReadableByteChannel source, String charsetName) {
     ...
     * @return this scanner
     */
    public ProxyScanner useDelimiter(Pattern pattern) {
        delimPattern = pattern;
        return this;
    }
     ...
     * @return this scanner
     */
    public ProxyScanner useDelimiter(String pattern) {
     ...
     * @return this scanner
     */
    public ProxyScanner useLocale(Locale locale) {
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public ProxyScanner skip(String pattern) {
