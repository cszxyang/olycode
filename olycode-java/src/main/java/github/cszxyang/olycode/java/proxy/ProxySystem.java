...
public class ProxySystem {
    ...
    public final static InputStream in = new ThreadLocalInputStream();

    public final static PrintStream out = new ThreadLocalPrintStream();
    ...
    public static void closeBuffer() {
        ((ThreadLocalInputStream) in).close();
        out.close();
    }
